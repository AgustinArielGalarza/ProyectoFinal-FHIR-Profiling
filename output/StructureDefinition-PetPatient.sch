...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'https://example.org/fhir/StructureDefinition/EspecieAnimal']) &lt;= 1">extension with URL = 'https://example.org/fhir/StructureDefinition/EspecieAnimal': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://example.org/fhir/StructureDefinition/EstadoDelGenero']) &lt;= 1">extension with URL = 'https://example.org/fhir/StructureDefinition/EstadoDelGenero': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://example.org/fhir/StructureDefinition/RazaAnimal']) &lt;= 1">extension with URL = 'https://example.org/fhir/StructureDefinition/RazaAnimal': maximum cardinality of 'extension' is 1</sch:assert>
