Profile: PetParticularSigns
Parent: Observation
Id: PetParticularSigns
* ^url = "https://example.org/fhir/StructureDefinition/PetParticularSigns"
* ^status = #draft
* identifier ..0
* basedOn ..0
* partOf ..0
...
* code.coding.code 1..
* code.coding.code = #404684003 (exactly)
* code.coding.display 1..
* code.coding.display = "Señal particular del animal" (exactly)
